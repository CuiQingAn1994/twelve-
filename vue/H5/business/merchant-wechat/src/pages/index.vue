<template>
  <div class="index">
    ...
    <div class="head">
      ...
      <div class="income">
        <div class="today">
          <router-link to="/dividend" tag="div">
        ...
        <div class="under">
          <router-link to="/underling" tag="div">
    ...
    <div class="preview">
      <p class="yulan">
        ...
        <router-link to="/dividend" tag="span">
    ...
    <div class="out">
      <p>
        <a style="text-decoration:none;color:#101010" href="tel:4000081027"><img src="../../static/images/phone@2x.png" alt="" class="tel_icon"><span class="tel_nuber">客服电话&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;400-008-1027</span></a>
      </p>
      <div class="btn">
