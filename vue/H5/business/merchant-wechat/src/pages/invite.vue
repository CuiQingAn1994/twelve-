<template>
	<div class="invite">
		...
		<div class="nav">
		    ...
		    <p class="bar" :style="{borderBottomColor:idx==1?'#EA705B':'#fff',color:idx==1?'#EA705B':'#999999'}" @click="tab2()">邀请记录</p >
		...
		<div class="invite_left" v-if="leftBlock">
			<div class="topBox" v-if="boxHide">
				...
				<!-- 提示 -->
				<div class="tips">
					<p class="tips_text">您是<span class="tips_text_red">代理等级</span>，目前与官方合作的分润比例为7.5%，这里的文字怎么说呢文字怎么说呢文字怎么说呢文字怎么说呢文字怎么说呢文字怎么说呢</p>
				</div>

				<!-- 生成链接 -->
				<div class="link">
					<span class="btn" v-show="btn1" @click="sub()">确定生成代理链接</span>
					<span class="btn2" v-show="btn2">确定生成代理链接</span>
				</div>
			</div>
